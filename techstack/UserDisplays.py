def get_state_keyboard(state: str):
    if state == "tech-stack-main":
        return [["📌 اولویت‌های من", "📓 مشاهده اطلاعات ثبت‌شده", "📝 ثبت‌نام اولیه"], # "🔔 به من یادآوری کن", 
                ["📩 ارسال ویدئوی تسک بک‌اند", "💫 مشاهده نتایج مصاحبه و پرداخت شهریه"], # "🎥 مشاهده ویدئو‌های معارفه",
                ["🔙 بازگشت"]]
...
def get_state_text(state: str) -> str:
    if state == "tech-stack-main":
        ...
        return ("لطفاً لینک ویدئوی تسک بک‌اند خود را در اینجا ارسال کنید."
